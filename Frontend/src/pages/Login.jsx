...
const Login = () => {
  const { login, isAuthenticated, user, loading, authError, setAuthError } = useAuth();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (authenticatedUser?.preferences?.profession) {
        navigate('/home');
      } else {
        navigate('/onboarding');
      }
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Log in to continue your personalized news briefing.
        </p>
